          ...
          <div className="">
            ...
            >
              ...
              {navlinks.length > 0 &&
                ...
                <NavButton label="Logout" src={logout} className={`!mt-auto flex items-center py-4 pl-3 pr-20 mx-3 my-2 md:mx-0 md:px-4 hover:bg-gray-50/10 rounded-lg duration-200 cursor-pointer md:hover:bg-gray-200 md:bg-gray-50/10 ` } />
