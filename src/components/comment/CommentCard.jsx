      ...
      if (replies.length === 0) {
        ...
        setReplies((prev) => {
          ...
          const newResults = response.data.results
            .reverse()
            .filter((result) => !existingIds.has(result._id));
  ...
  return (
    <>
      <Wrapper col="true" className="relative rounded-2xl !gap-2 ">
        ...
        {comment.numOfReplies > 0 && repliesNextCursor !== null && (
          <Wrapper
            onClick={() => {
        ...
        <Popup
          ...
          actions={[
            ...
            },
            {
              ...
              action:
                (showReplyPopup && handleAddReplyComment) ||
                (showEditReplyPopup && handleEditReplyComment),
            },
          ]}
              ...
              <Wrapper col="true" className="gap-4">
                <Heading className="text-center !text-[28px]">
                  {showEditReplyPopup
                    ? "Edit reply"
                    : `Reply comment of ${
                        replyComment && replyComment.user.username
                      }`}
                </Heading>
        ...
        <Popup
          ...
          actions={[
            ...
            },
            {
              ...
              danger: true,
              action: () =>
                replyComment && handleDeleteReplyComment(replyComment),
            },
          ]}
        />
      )}
